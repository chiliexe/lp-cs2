...
export const analyticsTool = {
  ...
  title: 'Como funciona o CashBack para restaurantes?',
  desc: `O BoltBank Cashback oferece uma plataforma gratuita que permite a bares, restaurantes do Rio Grande do Norte, criar seu próprio programa de fidelização com cashback.`,
  features: [
