...
import howWorksImage1 from 'common/assets/image/foodDelivery/1.png';
import howWorksImage2 from 'common/assets/image/foodDelivery/2.png';
import howWorksImage3 from 'common/assets/image/foodDelivery/3.png';
...
export const HOW_WORKS_DATA = {
  ...
  posts: [
    {
      icon: howWorksImage1,
      title: 'Cliente realiza uma compra',
      text: "",
      link: {
        label: 'Quero ser um parceiro',
        path: 'https://api.whatsapp.com/send?phone=558431901700&text=Oi!%20quero%20cashback%20para%20minha%20empresa',
      },
    },
    {
      icon: howWorksImage2,
      title: 'Seu cliente recebe o Cashback',
      text: '',
      link: {
        label: 'Quero ser um parceiro',
        path: 'https://api.whatsapp.com/send?phone=558431901700&text=Oi!%20quero%20cashback%20para%20minha%20empresa',
    ...
    {
      icon: howWorksImage3,
      title: 'Ele retorna para gastar o Cashback',
      text: '',
      link: {
        label: 'Quero ser um parceiro',
        path: 'https://api.whatsapp.com/send?phone=558431901700&text=Oi!%20quero%20cashback%20para%20minha%20empresa',
...
import bannerImage from 'common/assets/image/foodDelivery/cashback1.png';
import bannerBtn1 from 'common/assets/image/foodDelivery/banner-apple.png';
